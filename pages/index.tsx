...
//         </div>
//         <div className="col-span-4 h-96 p-9 rounded border bg-black-200">
//           <div className="">Embed climate data anywhere</div>
//           <div className="text-h1">Widgets & Banners</div>
//         </div>
//         <div className="col-span-4 h-96 p-9 rounded border bg-black-200">
//           <div className="">...</div>
//           <div className="text-h1">Data Expoer</div>
//         </div>
//         <div className="col-span-4 h-96 p-9 rounded border bg-black-200">
//           <div className="">Embed climate data anywhere</div>
//           <div className="text-h1">Widgets & Banners</div>
//         </div>
//         <div className="col-span-4 h-12 bg-black-200">
//           <div className="grid grid-cols-4 gap-4">
//             <div className="col-span-4 sm:col-span-2 md:col-span-3">
//               Examples
//             </div>
//             <div className="col-span-4 sm:col-span-2 md:col-span-1  rounded border bg-black-200">
//               Read the docs
//             </div>
//           </div>
//         </div>
...
//           <div className="rounded border bg-black-200">
//             <Link href="#">
//               <a>↗</a>
//             </Link>
//           </div>
